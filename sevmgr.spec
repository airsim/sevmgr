...
%description
%{name} aims at providing a clean API, and the corresponding C++ implementation,
to manage a discrete event queue on behalf of a simulation project.

Install the %{name} package if you need a library for handling the
discrete event queue of your simulation project.
...
%changelog
* Mon Apr 25 2011 Denis Arnaud <denis.arnaud_fedora@m4x.org> 99.99.99-1
- First RPM release
